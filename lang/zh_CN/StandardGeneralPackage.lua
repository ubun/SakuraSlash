...
return {
	...
	["kudoushinichi"] = "工藤新一",
	["zhenxiang"] = "真相",
	[":zhenxiang"] = "出牌阶段，你可以令任一其他角色的手牌对你可见，直到回合结束为止，每回合限一次；\
    你的回合外，当其他角色使用一张非延时类锦囊（【五谷丰登】除外）选择你为目标（或之一）后，你可以观看其手牌。",
...
--★结算后反悔举例：当你用过河拆桥拆A，B出了无懈可击，你反无懈，A被拆。执行反悔操作，A从弃牌堆里收回被拆的牌，你回收无懈可击，B回收无懈可击，你回收过河拆桥，完毕",
	...
	["lanman"] = "烂漫",
	[":lanman"] = "当你的手牌数小于4时，你可以将一张方块手牌当【无中生有】使用",
	["dontcry"] = "不哭",
	[":dontcry"] = "觉醒技，你的首个回合会跳过弃牌阶段，若你的第二个回合结束之后依然存活，你增加1点体力上限并回复全部体力",
	...
	["kyougokumakoto"] = "京极真",
	["shenyong"] = "神勇",
	[":shenyong"] = "出牌阶段，当你使用【杀】造成的伤害结算后，你可以视为对原目标攻击范围内的另一目标使用了一张【杀】。神勇可连锁发动但每名角色只能被指定一次目标。\
★神勇连锁举例：A对B出杀(黑桃8)，B没闪掉血，继续指定B攻击范围内的C，C没闪掉血，再指定C攻击范围内的D，D出闪，结束",
	...
	["yirong"] = "易容",
	[":yirong"] = "限定技，当你处于濒死状态时，你可以重新选择一次武将且体力回复至3点。",--	死亡再复活插入的技能可能会比较多，而且还有个奖惩的过程，没啥必要，而且比较强，没桃才会发动，所以改成庞统的时机，比较合适些。
	["@yaiba"] = "面膜",
...
--	[":bjvh"] = "回合开始阶段开始时，你可以弃一张牌，改变自己的性别。",
	["tishen"] = "替身",
	[":tishen"] = "限定技，当你处于濒死状态时，你可以进行一次判定，若判定结果为梅花，你的体力回复至3点。",
	...
	["nakamoriaoko"] = "中森青子",
	["renxing"] = "任性",
	[":renxing"] = "单发技，你可以与一名体力比你多的角色拼点，若你赢，你获得其一张牌。若你没赢，你失去1点体力。",
	["qingmei"] = "青梅",
