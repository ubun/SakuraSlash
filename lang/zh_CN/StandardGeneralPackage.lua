...
2、出牌阶段主动指定一名角色为目标A，直到此回合结束A的手牌始终对你处于可见状态",
	...
	["wuwei"] = "无畏",
	[":wuwei"] = "主公技，当你在回合外受到伤害时，可以要求其他角色轮流对伤害来源使用一张【杀】（视为你使用）",
	...
	["hattoriheiji"] = "服部平次",
	["rexue"] = "热血",
	[":rexue"] = "当你受到伤害时，可将一名角色的一张牌置于该角色的武将牌上，称为“热血牌”，同时该角色获得如下技能：在濒死时，可以弃掉一张热血牌为自己回复1点体力\
★当服部平次阵亡后，拥有热血牌的角色依然可以用热血自救",
	["rexue_get"] = "热血·救援",
	["jiaojin"] = "较劲",
	[":jiaojin"] = "单发技，你可以向一名有手牌的角色展示一张手牌，对方必须展示一张相同花色的手牌，否则选三张牌弃置\
★单发技的定义：每回合出牌阶段可以发动且只能发动一次的技能",
	["@jiaojinask"] = "%src 发动了【较劲】，如果你没有和 %arg 相同花色的手牌，你的装备或手牌将不保",

	["mourikogorou"] = "毛利小五郎",
	["chenshui"] = "沉睡",
	[":chenshui"] = "回合开始阶段，你可以选择跳过判定阶段、摸牌阶段和出牌阶段，然后从主公开始结算：除你之外的所有角色必须打出一张【杀】，否则受到你造成的1点伤害；你可以同时指定一名角色不参与本结算",
...
--★结算后反悔举例：当你用过河拆桥拆A，B出了无懈可击，你反无懈，A被拆。执行反悔操作，A从弃牌堆里收回被拆的牌，你回收无懈可击，B回收无懈可击，你回收过河拆桥，完毕",
	...
	["fuyuan"] = "复原",
	[":fuyuan"] = "主公技，若你在弃牌阶段弃掉的手牌不少于两张且场上没有工藤新一，在回合结束阶段开始前，你可以获得工藤新一的武将技，有效期至你下个回合的弃牌阶段",
	...
	["shiyan"] = "实验",
	[":shiyan"] = "单发技，你可以对自己的一张手牌进行判定，若判定牌和此牌花色相同，摸两张牌。无论结果，你都获得此判定牌",
	...
	["dontcry"] = "不哭",
	[":dontcry"] = "觉醒技，首次行动跳过弃牌阶段，第二次行动之后增加1点体力上限并回复全部体力",
	...
	["touyamakazuha"] = "远山和叶",
	["heqi"] = "合气",
	[":heqi"] = "当你成为【杀】的目标时，若你的手牌没有【杀】的使用者的所有牌多，可以立即获得其一张手牌或一张判定区里的牌",
	["shouqiu"] = "手球",
...
★神勇连锁举例：A对B出杀(黑桃8)，B没闪掉血，继续指定B攻击范围内的C，C没闪掉血，再指定C攻击范围内的D，D出闪，结束",
	...
	["kaitoukid"] = "怪盗基德",
	["shentou"] = "神偷",
	[":shentou"] = "你可以将任意锦囊当【顺手牵羊】使用且无距离限制；若出牌阶段你使用【顺手牵羊】超过两次，可以跳过弃牌阶段",
	["baiyi"] = "白衣",
	[":baiyi"] = "单发技，你可以卸掉自己的一件装备并让一名其他角色观看自己的手牌",
	["feixing"] = "飞行",
	...
	["megurejyuuzou"] = "目暮十三",
	["quzheng"] = "取证",
	[":quzheng"] = "你可以获得其他角色弃牌阶段弃掉的非武器牌。摸牌阶段摸牌前，若你的手牌数大于体力上限，必须放弃摸牌",
	["ranglu"] = "让路",
...
★发动调兵时，警势力角色可以打出【杀】、【决斗】和【火攻】来响应，若造成伤害，伤害来源为响应调兵的角色",
...
--	[":bjvh"] = "回合开始阶段，你可以弃一张牌，改变自己的性别",
	["tishen"] = "替身",
	[":tishen"] = "限定技，当你濒死时，可做一次判定，若为梅花，恢复体力至3点",
	["$tishen"] = "私に対してとてもキッドにとってできないことはない!",
	["@fake"] = "假人",
	["moshu"] = "魔术",
	[":moshu"] = "在任意角色摸牌阶段前，你可以获得堆顶的两张牌，然后选择两张牌替换之，每轮限一次",
	...
	["gin"] = "琴酒",
	["ansha"] = "暗杀",
	[":ansha"] = "限定技，出牌阶段，弃掉四张不同花色的手牌，令一名角色获得一枚暗杀标记（不明示）。该角色在其回合结束阶段受到你对其造成的3点伤害，发动后体力上限-1",
	["@ansha"] = "杀气",
	["$ansha"] = "安息吧，永远地安息吧……",
	["#Ansha"] = "%from 的技能【%arg】生效，目标是 %to",
	["juelu"] = "绝戮",
	[":juelu"] = "当你的【杀】造成伤害后，可以对受到伤害的角色再使用一张【杀】",
	...
	["dashou"] = "打手",
	[":dashou"] = "回合结束阶段，你可以向每名其他角色索要一张牌，若你获得的牌大于两张，将武将牌翻面",
	...
	["agasahiroshi"] = "阿笠博士",
	["gaizao"] = "改造",
	[":gaizao"] = "摸牌阶段摸牌前，弃掉一名角色装备区的一张牌，自己和对方同时摸一张牌",
	...
	["yuanding"] = "园丁",
	[":yuanding"] = "出牌阶段，你可以亮出一张手牌并指定一名有手牌的角色，该角色需给你一张手牌，然后获得你亮出的这张牌。对每名角色只能发动一次",
	...
	["jingshen"] = "敬神",
	[":jingshen"] = "单发技，每回合你可以将一张手牌移出游戏作为“祭品”，当祭品数和场上人数相等时，将全部祭品交给一名角色",
	["jipin"] = "祭品",
