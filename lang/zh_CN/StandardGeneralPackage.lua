...
2、出牌阶段主动指定一名角色为目标A，直到此回合结束A的手牌始终对你处于可见状态",
	...
	["wuwei"] = "无畏",
	[":wuwei"] = "主公技，当你在回合外受到一次伤害时，可以要求其他角色轮流对伤害来源使用一张【杀】（视为你使用）",
	...
	["hattoriheiji"] = "服部平次",
	["rexue"] = "热血",
	[":rexue"] = "当你受到伤害时，可将一名角色的一张牌置于该角色的武将牌上，同时该角色获得如下技能：在濒死时，可以弃掉一张热血牌为自己回复一点体力\
★当服部平次阵亡后，拥有热血牌的角色依然可以用热血自救",
	["rexue_get"] = "热血·救援",
	["jiaojin"] = "较劲",
	[":jiaojin"] = "单发技，你可以向一名有手牌的角色展示一张手牌，对方必须展示一张相同花色的手牌，否则需弃掉三张牌\
★单发技的定义：每回合出牌阶段可以发动且只能发动一次的技能",
	["@jiaojinask"] = "%src 发动了【较劲】，如果你没有和 %arg 相同花色的手牌，你的装备或手牌将不保",

	["mourikogorou"] = "毛利小五郎",
	["chenshui"] = "沉睡",
	[":chenshui"] = "回合开始阶段，你可以选择跳过判定阶段、摸牌阶段和出牌阶段，若如此做，从主公开始除你之外的所有角色必须打出一张【杀】，否则受到你造成的一点伤害，你可以指定一名角色不受技能影响",
...
--★结算后反悔举例：当你用过河拆桥拆A，B出了无懈可击，你反无懈，A被拆。执行反悔操作，A从弃牌堆里收回被拆的牌，你回收无懈可击，B回收无懈可击，你回收过河拆桥，完毕",
	...
	["fuyuan"] = "复原",
	[":fuyuan"] = "主公技，若你在弃牌阶段弃掉两张或两张以上的手牌且场上没有工藤新一，你可以获得工藤新一的武将技，有效期至你下个回合的弃牌阶段",
	...
	["shiyan"] = "实验",
	[":shiyan"] = "单发技，你可以对自己的一张手牌进行判定，若判定牌和此牌花色相同，可摸两张牌。无论结果，你都获得此判定牌",
...
★神勇连锁举例：A对B出杀(黑桃8)，B没闪掉血，继续指定B攻击范围内的C，C没闪掉血，再指定C攻击范围内的D，D出闪，结束",
	...
	["megurejyuuzou"] = "目暮十三",
	["quzheng"] = "取证",
	[":quzheng"] = "你可以获得其他角色弃牌阶段弃掉的所有牌。摸牌阶段摸牌前，若你的手牌数大于体力上限，必须放弃摸牌",
	["ranglu"] = "让路",
