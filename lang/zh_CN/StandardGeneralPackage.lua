...
return {
	...
	["$zhenxiang"] = "真相永远只有一个！",
	["$wuwei1"] = "等着我，我马上就过来！",
	["$wuwei2"] = "我一定会把你们都揪出来！（缺）",
	["~kudoushinichi"] = "死的时候我们也会在一起……",
...
★服部平次死亡后，拥有热血牌的角色依然可以执行该效果。",
	["rexue_get"] = "热血·救援",
	["jiaojin"] = "较劲",
	[":jiaojin"] = "单发技，你可以展示一张手牌，令任一其他有手牌的角色展示一张相同花色的手牌，否则该角色弃置三张牌。\
★单发技的定义：每回合出牌阶段可以发动且只能发动一次的技能。",
	["@jiaojinask"] = "%src 发动了【较劲】，如果你没有和 %arg 相同花色的手牌，你的装备或手牌将不保",
	["$rexue1"] = "真不介意的话再倒贴根晾衣杆给你也行。",
	["$rexue2"] = "（缺）",
	["$jiaojin1"] = "目前为止，我比这家伙要领先一步。",
	["$jiaojin2"] = "这起事件就由我来解决了。",
	["~hattoriheiji"] = "丢脸啊，我服部平次一生的最大失败！",
...
--★结算后反悔举例：当你用过河拆桥拆A，B出了无懈可击，你反无懈，A被拆。执行反悔操作，A从弃牌堆里收回被拆的牌，你回收无懈可击，B回收无懈可击，你回收过河拆桥，完毕",
	...
	["$jingxing1"] = "凶手就是你！", -- 令别人弃牌
	["$jingxing2"] = "哇哈哈哈，啤酒也好喝！", -- 自己摸牌
	["~mourikogorou"] = "男人的眼泪~~~",

	["edogawaconan"] = "江户川柯南",
	["cv:edogawaconan"] = "高山みなみ",
	["zhinang"] = "智囊",
	[":zhinang"] = "回合结束时，你可以将手牌补至体力上限的张数；回合外，当你失去一张手牌时，可以摸一张牌。",
	["mazui"] = "麻醉",
	[":mazui"] = "单发技，你可以将红桃基本牌当【偷袭】使用；你使用【偷袭】无距离限制。",
	["fuyuan"] = "复原",
	[":fuyuan"] = "主公技，弃牌阶段，当你的弃牌不少于两张且场上没有工藤新一时，你可以获得技能【真相】和【无畏】，直到你下回合的弃牌阶段开始时。",
	...
	["$lanman1"] = "快看这个！",
	["$lanman2"] = "我们是少年侦探团！",
	["$dontcry"] = "我不想逃避！逃避是不会胜利的！", -- 缺，在347集
	["~yoshidaayumi"] = "柯南，一定要把我们都复活哦~",
	...
	["shouhou"] = "守候",
	[":shouhou"] = "回合结束阶段开始时，你可以将自己的武将牌翻面；当你的武将牌被翻面时，可令一名角色回复1点体力。",
	["@shouhou"] = "你的武将牌被翻面，可以发动【守候】令一名角色回复1点体力",
	["$duoren1"] = "(音效)",
	["$duoren2"] = "活泼的花季女高中生。",
	["$shouhou1"] = "简直像个傻瓜一样……",
	["$shouhou2"] = "生日快乐，新一。",
	["~mouriran"] = "对不起，不能陪你到最后……",
	...
	["@face"] = "面膜",
	["$yirong"] = "至少天使从未对我微笑过，一次也没有。", -- 缺 在286集找
	["$wuyu"] = "这个世界上真的有上帝吗？", -- 缺
...
★发动调兵时，警势力角色可以打出【杀】、【决斗】和【纵火】来响应，若造成伤害，伤害来源为响应调兵的角色",
	...
	["$guilin1"] = "可以的话，请坐我的车。", -- 挡伤害
	["$guilin2"] = "从那时开始，我就爱上你了。",
	["$guilin3"] = "上天果然没有抛弃我。", -- 奸雄
	["~shiratorininzaburou"] = "没能像你一样顺利躲过啊……",
	...
	["juelu"] = "绝戮",
	[":juelu"] = "你每造成一次伤害后，可以对目标角色使用一张【杀】。",
	["juelu-slash"] = "你可以发动【绝戮】，追【杀】目标！",
	["heiyi"] = "黑衣",
	[":heiyi"] = "主公技，其他黑势力角色可以跳过自己的摸牌阶段，令你在下回合的摸牌阶段摸牌时额外摸两张牌。",
	["@heiyi"] = "黑衣",
	["$ansha"] = "他要不是幽灵的话，就让你变成幽灵。", -- 缺
	["$juelu"] = "朝他脑袋开一枪。",
	["$heiyi1"] = "好像有人老是在注意我们。", -- 琴酒
	["$heiyi2"] = "暂无", -- 其他人
	["~gin"] = "不用管了，快撤！",
	...
	["cv:akaishuichi"] = "池田秀一",
	["jushen"] = "狙神",
	[":jushen"] = "锁定技，当你装备的武器攻击范围不小于2时，你使用的【杀】不可被【闪】响应。",
	...
	["@aka"] = "红色",
--	["$jushen"] = "银色子弹，只要一发就够了……", -- 缺
	["$jushen"] = "我那可爱的宿敌、恋人先生。",
	["$xunzhi"] = "保时捷365A……原来如此……",

	["agasahiroshi"] = "阿笠博士",
	["cv:agasahiroshi"] = "緒方賢一",
	["gaizao"] = "改造",
