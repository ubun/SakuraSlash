...
local t = {
	...
	["jaguarE"] = "捷豹E-type",
	[":jaguarE"] = "装备牌·车[进攻]<br />你计算与其他角色的距离时，始终-1<br/>◆工藤有希子专用技：你发动“乙女”无距离限制",
	["citroBX"] = "雪铁龙BX19",
	[":citroBX"] = "装备牌·车[防守]<br />其他角色计算与你的距离时，始终+1<br/>◆本堂瑛海专用技：你视为同时拥有基尔的技能",
...
--
	...
	["tantei"] = "侦探徽章", -- 3枚
	[":tantei"] = "装备牌·防具牌<br />防具效果：当你需要打出一张【杀】或【闪】时，可请求另一名装备侦探徽章的角色帮你出【杀】或【闪】（视为由你打出）；<b>锁定技</b>，装备侦探徽章的角色每受到一次伤害，你摸一张牌",
