...
return {
	...
	["kamenyaibaa"] = "假面超人",
	["feiti"] = "飞踢",
	[":feiti"] = "当你造成一次伤害时，可以避免此伤害，获得X个标记，X为造成伤害的点数；回合结束阶段开始时，你可以弃掉1个标记，对攻击范围外的一名角色造成1点伤害。",
	["@yaiba"] = "假面",
	...
	["yokomizo"] = "横沟兄弟",
	["canwu"] = "参悟",
	[":canwu"] = "出牌阶段，你可以弃一张梅花牌并指定一名其他男性角色，你和其各回复一点体力。",
	["chongwu"] = "重悟",
	...
	["kir"] = "基尔",
	["wulian"] = "无怜",
	[":wulian"] = "在以下情况下，你的【杀】不可闪避：你的体力值等于对方的体力值；你的体力值等于对方的当前手牌数。",
	...
	["enomotoazusa"] = "榎本梓",
	["zhaodai"] = "招待",
	[":zhaodai"] = "单发技，出牌阶段，你可以将一张基本牌交给任一其他角色，然后选择一项：摸一张牌，或令其摸一张牌。",
	["kaxiang"] = "咖香",
