...
return {
	...
	["kanpo"] = "看破",
	[":kanpo"] = "你可以将一张黑色非锦囊牌当【无懈可击】使用。",

	["kawaguchisatoshi"] = "川口聪",
	["foyuan"] = "佛缘",
	[":foyuan"] = "你可以将一张黑色基本牌当【佛跳墙】使用且无距离限制。",
	...
	["kurobatouichi"] = "黑羽盗一",
	["guifu"] = "鬼斧",
	[":guifu"] = "锁定技，游戏开始时，你获得2个“鬼斧”标记。你每造成X点伤害时，获得X个“鬼斧”标记（总数最多为5）；你每受到X点伤害或流失X点体力时，失去X个“鬼斧”标记并防止此次伤害或流失。扣减体力上限对你无效。你的手牌上限+2。当你没有“鬼斧”标记时，须立即做一次判定，若为【桃】或红色锦囊，你获得1个“鬼斧”标记，否则将体力设为0并进入濒死阶段。",
	["shengong"] = "神工",
