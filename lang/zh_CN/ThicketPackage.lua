...
return {
	...
	["matsudajinpei"] = "松田阵平",
	["chaidan"] = "拆弹",
	[":chaidan"] = "单发技，回合开始阶段，你可以弃一张与某角色判定区内的一张牌判定生效花色相同花色的牌，来拆除这张牌\
★判定生效花色是延时锦囊产生效果的花色，比如【乐不思蜀】的生效花色是方块、黑桃和梅花，发动拆弹后，（举例）可以弃掉除红桃外的任意花色牌，就能拆除【乐不思蜀】",
	["julun"] = "巨轮",
	[":julun"] = "限定技，从你开始，依次摸下家一张牌，若下家没牌，受到来自上家的一点伤害",

	["tsuburayamitsuhiko"] = "圆谷光彦",
	["conghui"] = "聪慧",
	[":conghui"] = "单发技，出牌阶段，将一张手牌暗扣于功能区内，从下家开始轮流猜点数，不能猜已经猜过的，最接近正确答案的在该牌进入弃牌堆时获得，猜点成绩排名靠后的一半角色（向下取整）失去一点体力。猜点结算后你必须立即使用这张牌，若无法使用失去一点体力",
	["qingyi"] = "情义",
	[":qingyi"] = "每回合你可以指定一名少势力角色，不需参加聪慧的猜点，对方可以拒绝\
★猜点举例：手牌点数是3。二位猜4，三位猜1，四位猜10，五位猜5，六位本来想猜4，但已经有人猜4，所以改猜12，七位猜3，八位猜9。最后结算，七位猜对，获得这张牌。有三位需要失去体力，按照差值由大到小依次是六位（差9），四位（差7），八位（差6）",

	["tabuseharuna"] = "田布施阳菜",
	["bushi"] = "布施",
	[":bushi"] = "单发技，出牌阶段，你可弃掉差值数的手牌，互换除主公外两名角色的体力值\
★互换体力时，若遇到上限溢出问题，以上限为界流失体力，比如3血3上限和4血4上限交换后，变成3血3上限和3血4上限",
	["kaixin"] = "开心",
	[":kaixin"] = "你可以拿走【五谷丰登】的所有牌",
	["loli"] = "萝莉",
	[":loli"] = "锁定技，红色的【杀】对你无效",
	...
	["cimu"] = "慈母",
	[":cimu"] = "主公技，你可以弃一张质数点数的牌，指定一名侦势力或艺势力角色，在自己下回合开始前获得“铁扇”技能",
...
★工藤家族角色，指工藤优作，工藤有希子，工藤新一，江户川柯南",
	...
	["jiikounosuke"] = "寺井黄之助",
	["zhongpu"] = "忠仆",
	[":zhongpu"] = "你每受一点伤害，可指定除你之外的一名角色摸两张牌或回复一点体力",
	["zhiqu"] = "智取",
	...
	["jamesblack"] = "詹姆斯·布莱克",
	["anyong"] = "暗涌",
	[":anyong"] = "单发技，回合开始阶段，你可以对任意角色判定，若为黑色，该角色在下次行动时可以跳过弃牌阶段",
	["panda"] = "熊猫",
