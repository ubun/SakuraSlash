...
return {
	...
	["#AskForPeaches"] = "%from 向 %to 求肉，一共需要 %arg 坨肉",
	["#ChooseKingdom"] = "%from 选择了 %arg 作为他的国籍",
	["#NullificationDetails"] = "无懈的对象是 %from 对 %to 的技能牌 %arg",
	...
	["#DelayedTrick"] = "%from 的延时技能牌【%arg】开始判定",
	...
	["cw"] = "顺时针",
	["ccw"] = "逆时针",
	["#TrickDirection"] = "%from 选择了 %arg 作为技能牌的顺序",
}